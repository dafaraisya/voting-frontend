...
export default {
    ...
    methods:{
        del(){
            Swal.fire({
                ...
                if (result.isConfirmed) {            
                    axios
                        .delete("http://pemilu.himatekkits.com:3000/api/v1/participant/"+this.$route.params.id)
                        .then(() => {
                            Swal.fire({
                                icon: 'success',
        ...
        send(to, name, nim, id) {
            ...
            .then(function (image) {
                ...
                axios
                    .post("http://pemilu.himatekkits.com:3000/api/v1/mail/", data)
                    .then(() => {
                        Swal.fire({
                            icon: 'success',
    ...
    mounted() {
        axios
            .get("http://pemilu.himatekkits.com:3000/api/v1/participant/"+this.$route.params.id)
